      ...
      minimizer: [new TerserPlugin({
        ...
        terserOptions: {
          ...
          compress: {
            ...
            inline: 2,
            'drop_debugger': true,
            'drop_console': true, // console, uat and test model don't has this key
            'pure_funcs': ['console.log', 'console.error'], // Remove console, uat and test model don't has this key
          },
          mangle: {
